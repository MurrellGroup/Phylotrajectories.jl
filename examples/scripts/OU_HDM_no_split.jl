...
path = "/home/masha/CLEAN_PhyloTrajectory_paper/results/HDM_no_split"

clono_info, cluster_names, _, count_matrix = import_count_matrix(
    "/home/masha/PhyloTraj_paper/Final_notebooks/HDM/HDM_clone_data_notcr_091125.tsv",
    :Clonotype,
    :cell_types,
    :TRB_cdr3aa,
...
savefig(combined_plt, "$(path)/OU_HDM_no_split_$(digamma_value)_$(trigamma_value)_$(number_seed)_theta.pdf")
savefig(hipster_tree, "$(path)/OU_HDM_no_split_$(digamma_value)_$(trigamma_value)_hipster_$(number_seed)_theta.pdf")

# Save a representative tree from the MCMC samples (e.g., the last tree)
Phylo.write("$(path)/OU_HDM_no_split_$(digamma_value)_$(trigamma_value)_HIPSTR_$(number_seed)_theta.newick", get_phylo_tree(hip))
...
UMAP_coords = CSV.read("/home/masha/PhyloTraj_paper/Final_notebooks/HDM/UMAP_coords_091125.tsv", delim='\t',DataFrame);
